...
public class Test {
	...
	public static void main(String[] args) {
		...
		versions[0] = new PlatformInfo(Platform.JDK, 1.0, "none", 1996,
				"JDK 1.2.0 is the first stable  " + "version called Java1.");
		...
		versions[2] = new PlatformInfo(Platform.J2SE, 1.2, "Playground", 1998,
				"Swing, Collections framework," + " 1520 classes in 59 packages;");
		...
		versions[7] = new PlatformInfo(Platform.JAVASE, 1.7, "Dolphin", 2011, "JVM support for dynamic lgs, etc...");
		versions[8] = new PlatformInfo(Platform.JAVASE, 1.8, "Spider", 2014, "Streams, Lambda, Date&Time Api");
		versions[9] = new PlatformInfo(Platform.JAVASE, 1.9, "none", 2017, "jshell, XML Calatogs, etc...");
		versions[10] = new PlatformInfo(Platform.JAVASE, 10, "none", 2018, "Garbage Collector Interface, etc...");
